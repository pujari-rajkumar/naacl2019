...
parser.add_argument('--dataset', type=str, default='multirc', help='dataset in use')
parser.add_argument('--gpu', type=str, default='0', help='GPU to use')
parser.add_argument('--epoch', type=int, default=15, help='Number of epoches to run')
...
parser.add_argument('--embedding_file', type=str, default='/homes/rpujari/scratch/data/yunfudao/commonsense-rc-master/data/glove.840B.300d.txt', help='embedding file')
