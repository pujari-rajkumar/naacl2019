...
def str2bool(v):
    return v.strip().lower() in ('yes', 'true', 't', '1', 'y')

parser = argparse.ArgumentParser()
parser.register('type', 'bool', str2bool)
parser.add_argument('--dataset', type=str, default='multirc', help='Name of the dataset')
parser.add_argument('--use_race_pretraining', type=bool, default=False, help='Whether or not to use pre-trained parameters from RACE dataset')
...
parser.add_argument('--emb_eg', type=str, default='./data/temp_example', help='Path to the file to compute trained embeddings')
